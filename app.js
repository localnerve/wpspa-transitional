...
var rewriteRules = [
  ...
  '!(\\.(css|js|png|gif|jpg|ico|txt|xml|html|ttf|eot|svg|woff)(\\?.*)?$) /index.html [NC L]'
];
...
app.use(maintenance.five03);

// local api service overrides
...
app.get("/"+config.four04File, notfound.four04);
