...
define([
  ...
  "helpers/routes",
  "helpers/types"
], function(_, contract, routes, types) {
  ...
  function parsePost(post) {
    ...
    return {
      ...
      object_type: types.makeObjectType(
        post.custom_fields._menu_item_wpspa_post_type[0],
        post.custom_fields._menu_item_wpspa_menu_text[0]
      ),
