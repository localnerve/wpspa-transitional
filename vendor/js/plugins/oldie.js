...
define([], function() {
  ...
  // This doesn't work correctly, but I care so little about IE7 that it won't get fixed.
  // It doesn't "work" because the loop ends up hiding the art in the z order.
  // But it does fix the critical functioning parts.
  var zIndex = function() {
